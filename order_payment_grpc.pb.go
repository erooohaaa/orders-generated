...
const (
	...
	PaymentService_ListPayments_FullMethodName   = "/api.PaymentService/ListPayments"
)
...
const (
	OrderService_SubscribeToOrderUpdates_FullMethodName = "/api.OrderService/SubscribeToOrderUpdates"
)
